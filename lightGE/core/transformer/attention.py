...
from lightGE.core.tensor import Tensor, concat
import numpy as np
...
class SelfAttention(Model):
    def __init__(self, n_inputs, n_outputs, mask=False):
        ...
        self.mask = mask
        self.Wq = Linear(n_inputs, n_outputs)
        self.Wk = Linear(n_inputs, n_outputs)
        self.Wv = Linear(n_inputs, n_outputs)
...
class MultiAttention(Model):
    def __init__(self, n_heads, n_inputs, mask=False):
        ...
        self.linear = Linear(self.n_inputs, self.n_outputs)
